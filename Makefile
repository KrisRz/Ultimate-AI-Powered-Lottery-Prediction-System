.PHONY: setup setup-update predict play dashboard backtest fairness ensemble ensemble-null popularity-audit backfill sales nightly test roi roi-settle post-draw install-cron site-data site-data-check uplift
