...
from models.utils import ensure_valid_prediction
...
def load_data(file_path='data/fixed_lottery_data_v2.csv'):
    """
...
def main(data_path='data/fixed_lottery_data_v2.csv', look_back=None, epochs=20):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data", type=str, default="data/fixed_lottery_data_v2.csv",
